...
export default function CreateDM({ close }) {
  ...
  return (
    <div className={`relative overflow-hidden w-[620px] h-[900px]`}>
      {/* Create DM Component */}
      <div
      ...
      >
        <div className=" pb-4 bg-[var(--main-color)] pt-4 px-4 rounded-sm border border-[var(--g-color)] flex flex-col">
