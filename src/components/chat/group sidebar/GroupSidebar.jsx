...
export default function GroupSideBar() {
    ...
    const adminName = "Malek"; // Define the admin
            ...
            <div className="flex-col flex-nowrap w-full h-min">
                ...
                <div className="mb-4">
                    {brothersDataArray.map((brother) => (
                        <GroupSidebarCard key={brother} name={brother} isAdmin={brother === adminName} />
                    ))}
                </div>
            </div>
...
function GroupSidebarCard({ name, isAdmin }) {
    return (
        <div className="flex items-center justify-between p-3 hover:bg-[var(--main-color-hover)] cursor-pointer">
