  ...
  return (
    <div className='flex flex-col items-center bg-[var(--dark-color)] w-min justify-center py-4 px-8 rounded-md'>
      ...
      <div className='flex flex-col gap-4' >
        ...
        <a href="email-verification"><button style={{width : "380px", borderRadius: "6px"}} className='px-4 py-2 bg-[var(--o-color)] text-xl text-[var(--w-color)] placeholder-[var(--g-color)] py-2 mb-8'>Send Verifivation</button></a>
      </div>
