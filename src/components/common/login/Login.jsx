    ...
    <div className="flex flex-col items-center bg-[var(--dark-color)] w-min justify-center py-4 px-8 rounded-md">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <a
          ...
          className="flex items-center justify-center text-[var(--b-color)]"
        >
          Forgot Password?
        </a>
      ...
      <a href={googleAuthUrl}>
        <div
          style={{ width: "380px" }}
          className="mt-2 mb-2 px-4 py-2 bg-[var(--secondary-color)] items-center flex text-xl text-[var(--w-color)] rounded-sm border border-[var(--main-color-hover)]"
        >
          <svg
            className="w-6 h-6"
            viewBox="-3 0 262 262"
          ...
          <p className="ml-auto mr-auto text-[var(--g-color)]">
            Login with Google
          </p>
        </div>
      </a>
