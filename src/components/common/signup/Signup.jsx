  ...
  return (
    <div className='flex flex-col items-center bg-[var(--dark-color)] w-min justify-center py-4 px-8 rounded-md'>
      ...
      <div className='flex flex-col gap-4' >
        ...
        <button style={{width : "380px"}} className='px-4 py-2 bg-[var(--o-color)] text-xl text-[var(--w-color)] placeholder-[var(--g-color)] rounded-sm py-2 mb-2'>Signup</button>
      </div>

      <p className='text-[var(--w-color)]'>Alreay have and account? <a className='text-[var(--b-color)]' href="login">Login</a></p>
