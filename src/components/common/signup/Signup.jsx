  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] right-[-10%] w-[600px] h-[600px] rounded-full blur-[150px] opacity-20" />
        ...
        >
          ...
          >
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                      ...
                      {isEmailNotVerifiedError && (
                        <div className="flex flex-col gap-2">
                          <button
                            ...
                            className="flex items-center gap-2 text-xs font-medium transition-colors disabled:opacity-50 hover:underline"
                            style={{ color: "var(--bright-b-color)" }}
                          >
                            <RefreshCw
                              size={12}
                              className={
                                resendStatus.loading ? "animate-spin" : ""
                              }
                            />
                          ...
                          {resendStatus.success && (
                            ...
                            >
                              <CheckCircle size={12} /> Verification email sent!
                            </span>
                          )}
                          {resendStatus.error && (
              ...
              {/* Submit */}
              <button
                className="w-full py-3.5 rounded-xl font-semibold text-sm transition-all duration-300 flex items-center justify-center gap-2 mt-2 group"
                style={{
                  background:
