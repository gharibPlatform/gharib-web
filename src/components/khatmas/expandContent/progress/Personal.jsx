            ...
            <table className="table-auto border-collapse">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="px-4 py-2">{pages}</td>
                    </tr>
                    <tr>
                        <td className="px-4 pr-16 py-2 font-medium">Remaining</td>
                        <td className="px-4 py-2">{remainingPages}</td>
                    </tr>
                    <tr>
    ...
    return(
        <div>
            <div className="flex items-center cursor-pointer gap-4 text-2xl text-[var(--w-color)] pl-6 pt-12" onClick={handleClick}>
                Personal
                <svg style={{transform: `rotate(${rotatePersonal}deg)`}} className="w-6 h-6 transition-all duration-200 ease" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M15 20L7 12L15 4" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
            </div>
