...
export default function QuranSurahSeparator({
  chapterId,
  paddingTopValue,
  pageNumber,
  basmalaPre,
      ...
      {pageNumber ? (
        <div style={{ fontFamily: "Cairo" }} className="flex flex-col">
          ...
          <div className="flex flex-col gap-22 justify-center items-center">
            <div
              style={{ fontFamily: "surahnames", paddingTop: paddingTopValue }}
              className="flex justify-center items-center text-6xl pb-8"
            >
              <div>surah</div>
              <div>{chapterId}</div>
            </div>
