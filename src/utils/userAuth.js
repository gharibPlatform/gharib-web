...
export async function googleAuth(data) {
  try {
    const response = await api.post(`${API_URL}/auth/google/`, data);
...
export async function changePassword(data) {
  try {
    const response = await api.post(`${API_URL}/auth/password/change/`, data);
    return response.data;
  } catch (error) {
...
export async function registerUser(data) {
  try {
    const response = await api.post(`${API_URL}/auth/registration/`, data);
    return response.data;
  } catch (error) {
...
//   try {
//     const response = await api.post(`${API_URL}/auth/token/refresh/`, data);
//     return response.data;
//   } catch (error) {
...
export async function verifyToken(data) {
  try {
    const response = await api.post(`${API_URL}/auth/token/verify/`, data);
    return response.data;
  } catch (error) {
...
export async function updateUserDataPut(data) {
  try {
    const response = await api.put(`${API_URL}/auth/user/`, data);
    return response.data;
  } catch (error) {
...
export async function updateUserDataPatch(data) {
  try {
    const response = await api.patch(`${API_URL}/auth/user/`, data);
    return response.data;
  } catch (error) {
